...
sheet_pref.delete_rows(get_index_blank(sheet_pref), sheet_pref.max_row)
stage = {}


for row in range(2, sheet_rang.max_row + 1):
    ...
    if not pref or not flag or matricule not in stage['Matricule']:
